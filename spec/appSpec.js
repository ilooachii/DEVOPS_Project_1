...
describe("minute line", function () {
    ...
    it("should return 'OOOO' when the time is 0:00", function () {
        const time = "0:00";
    ...
    it("should return 'YOOO' when the time is 0:01 ", function () {
    ...
    it("should return 'YYOO' when the time is 0:02", function () {
    ...
    it("should return 'YYYO' when the time is 0:03", function () {
    ...
    it("should return 'YYYY' when the time is 0:04", function () {
    ...
    it("should return 'OOOO' when given 0:05 ", function () {
        const time = "0:05";
